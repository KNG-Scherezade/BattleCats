...
namespace EZCameraShake
{
    ...
    public class CameraShaker : MonoBehaviour
    {
		...
		public static Vector3 camera_at_hit_time;
        ...
        {
			if (isHit) {
				posAddShake = GameObject.FindGameObjectWithTag("CameraDestination").transform.localPosition;
        ...
        public CameraShakeInstance ShakeOnce(float magnitude, float roughness, float fadeInTime, float fadeOutTime, Vector3 posInfluence, Vector3 rotInfluence)
        {
			...
			isHit = true;
			camera_at_hit_time = GameObject.FindGameObjectWithTag ("MainCamera").transform.position;
